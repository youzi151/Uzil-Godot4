...
func index (Uzil, _parent_index) :
	...
	self.PATH = _parent_index.PATH.path_join("user_save")
	...
	# 從 設定檔中 設置 存檔路徑
	var setting_key : String = "uzil/user_save/save_folder_path"
	if ProjectSettings.has_setting(setting_key) :
		var setting_save_folder = ProjectSettings.get_setting_with_override(setting_key)
