...
## 去符號後空白 "+" 正則式
var no_space_behind_positive_symbol_regex_pattern := "[+]\\ +"
## 去符號後空白 "+" 正則
var no_space_behind_positive_symbol_regex : RegEx = null
...
func _init () :
	...
	self.no_space_behind_positive_symbol_regex = RegEx.new()
	self.no_space_behind_positive_symbol_regex.compile(self.no_space_behind_positive_symbol_regex_pattern)
